...
if (isset($_GET['search'])) {
    ...
    $motors = $motorModel->searchMotors($searchTerm, $sortColumn, $sortOrder);
} else {
    if ($sortColumn) {
        $motors = $motorModel->getMotorsSorted($sortColumn, $sortOrder);
    } else {
        $motors = $motorModel->getMotorsOrderedByLikes();
    }
}
...
function sortLink($column, $label) {
    ...
    return "<a href='?sort=$column&order=$newOrder$search'>$label$arrow</a>";
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="app-content-actions">
                <div class="products-area-wrapper tableView">
                    <div class="products-header">
                        ...
                        <div class="product-cell stock"><?php echo sortLink('seat_height', 'Seat Height'); ?></div>
                        <div class="product-cell stock"><?php echo sortLink('weight', 'Weight'); ?></div>
                        <div class="product-cell stock"><?php echo sortLink('price', 'Price'); ?></div>
